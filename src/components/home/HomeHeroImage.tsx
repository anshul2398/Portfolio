...
function HomeHeroImage() {
    ...
    return (
        <div>
            <div className="relative aspect-[375/540] l:aspect-[3156/1200] z-[10]  ">
                {/* Desktop image (hidden on mobile) */}
                <Image
                    src='/webDeveloper.jpg'
                    alt='Anshul Web Developer'
                    layout="fill"
                    className="hidden l:block"
                />
                {/* Mobile image (hidden on desktop) */}
                <Image
                    src='/webdevelopermobile.png'
                    alt='Anshul Web Developer'
                    layout="fill"
                    className="block l:hidden"
                />
                <div className={` absolute bottom-[5rem] ml-[3.375rem] z-1 hidden l:block`} >
                ...
                <div className='hidden l:block absolute -bottom-20 h-[16.875rem] w-full ' style={{
            ...
            <div className={`    mx-4  h-[14.75rem]  relative block l:hidden z-10  p-4  -mt-12`} >
                <Image src='/DotGrid.png' alt='' layout='fill' className=' bg-[#fff]  rounded-[1.25rem] shadow-2xl' />
                <div className='relative z-10 flex flex-col   l:relative'>
                    <div>
                        <span className={`${anybody.className}  text-black italic  text-[1.25rem]  font-bold z-10`}>I am a web designer</span>
                        <p className={`${IBM_plex_mono.className}  text-black relative text-[0.875rem] mt-5 font-medium`}>I have been building webs on<br />internet for past 4 years, that has caught lot’s of <span className='line-through'>preys</span> customers</p>
                    </div>

                    <button className={`tip-button  s:mt-12 mt-10   ${IBM_plex_mono.className}`} onClick={() => {
                        setTimeout(() => {
                            setpopup(true)

                        }, 1300);
                    }}>
                        <span className="tip-button__text text-[0.875rem] font-semibold">Hire Me</span>
                        <div className="coin-wrapper">
                            <div className="coin ">
                                <div className="coin__middle"></div>
                                <div className="coin__back">
...
'>
                            ...
                            <div className={`w-full z-20  py-6  ${IBM_plex_mono.className}`}>
                                ...
                                <div className='pr-11'>
                                    ...
                                    <a href='/contact' className="glow-button rounded-[0.625rem]   mr-11 ">
                                        <p className='gloweffect flex items-center justify-center  mt-10 h-13'>Contact Me</p>
                                    </a>
