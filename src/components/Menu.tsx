        ...
        <div className=' fixed bottom-[5%]  w-[5.875rem] left-1/2 -translate-x-[50%] h-[6rem] cursor-pointer  z-[10]'>
            ...
            <div className='relative      w-full h-full z-10' >
                ...
                <div ref={popupRef} >
                    ...
                    {/* Home Navigation div */}
                    <div className={`${open ? ' -translate-x-[150%] -translate-y-[50%] ' : ' invisible  scale-50'} shinebtn1 shinebtn1-hover z-[5] transition-all duration-500 ease-out absolute  w-[5rem] left-0 rounded-[1.5rem] h-[5rem]   cursor-pointer active:scale-90 `} onClick={() => window.open('/', '_self')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 84 84" fill="none" >
