    ...
    return (
        ...
        <div className=' fixed bottom-[5%]  w-[5.875rem] left-1/2 -translate-x-[50%] h-[6rem] cursor-pointer  z-[10]'>
            ...
            <div className='relative      w-full h-full z-10' >
                ...
                <div ref={popupRef}  className={`${open ? ' -translate-y-[150%]  ' : ' invisible   scale-50'} z-[5]    transition-all duration-500 ease-out absolute  w-[5rem] left-1/2 -translate-x-[54%] rounded-[1.5rem] h-[5rem]  cursor-pointer `} onClick={() => window.open('/aboutme', '_self')}>
