...
function Footer() {
    return (
        <div className='bg-[#303030] flex flex-col items-center pt-16  pb-20'>
            ...
            <Image alt='' src='/ANSHUL.png' width={265} height={117} />

            <p className={`${IBM_plex_mono.className} text-[1.25rem] font-medium text-[#fff] mt-14`}>MADE with {'<'}3 using NextJs</p>

            <div className='flex items-center space-x-[10rem] mt-20'>
