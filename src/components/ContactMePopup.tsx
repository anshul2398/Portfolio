...
function ContactMePopup({ setemailpopup, IBM_plex_mono }) {
    ...
    return (
        <div className={`${IBM_plex_mono.className} z-50 fixed overflow-hidden bg-black/50 w-full h-full top-0 flex items-center justify-center `} onClick={()=>setemailpopup(false)}>

            <div className='w-[34.75rem] h-[34.75rem] bg-[#fff] font-medium text-[#303030] p-5' >
                ...
                <form className='mt-8 w-full'>
                    <div className={`${open ? ' border-t-[1px] border-l-[1px] border-r-[1px]  ' : ' border-[1px] '} text-[1rem]  relative z-10 px-4  bg-[#fff] h-10 flex items-center justify-between cursor-pointer w-full select-none`} onClick={() => setopen(!open)}>
                        ...
                        {open ?
                            <ul className="dropdown_menu dropdown_menu-4   text-[#303030]  border-b-[1px] border-l-[1px] border-r-[1px]  ">
                    ...
                    <div className={`${open1 ? ' border-t-[1px] border-l-[1px] border-r-[1px]  ' : ' border-[1px] '} text-[1rem]  relative z-10 px-4  bg-[#fff] h-10 flex items-center justify-between cursor-pointer w-full select-none mt-5`} onClick={() => setopen1(!open1)}>
                    ...
                    <textarea className='mt-5 border-[1px] h-[13rem] w-full outline-none px-4 py-3 text-[1] resize-none
' placeholder='What is it that you want to say...' onChange={(e) => setdesc(e.target.value)} value={desc}>
                ...
                <p className='text-[#888888] text-center mt-7'>I usually respond back in 24-48 hours</p>
            </div>
